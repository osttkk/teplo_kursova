...
menuTabs.addEventListener('click', function(e){
    ...
    if(e.target.classList.contains('menu-tab-item') && !e.target.classList.contains('active')){
        ...
        // Removes Active Class Form Active Tab
        menuTabs.querySelector('.active').classList.remove('active');

        // ADD Active Class Form Clicked Tab
...
document.querySelector('.btn1').addEventListener('click', function (event) {
    event.preventDefault(); // запобігає перезавантаженню сторінки при натисканні кнопки
    ...
    // Відправте дані на пошту
    Email.send({
      SecureToken: "", // токен 
      To: "teplokursova@gmail.com",
      From: email,
