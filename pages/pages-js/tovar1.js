...
const orderFormWrapper = document.querySelector('.form-wrapper');

buyBtn.addEventListener('click', () => {
  orderFormWrapper.classList.add('active');
});
...
orderForm.addEventListener('submit', (event) => {
  ...
  // тут можна додати логіку для відправки даних з форми на сервер
